...
EMBEDDED("shaders/classic/classic.vert", TEXT) const char g_shader_source_classic_vert[];
EMBEDDED("shaders/classic/classic.frag", TEXT) const char g_shader_source_classic_frag[];

EMBEDDED("shaders/shadow/shadow.vert", TEXT) const char g_shader_source_shadow_vert[];
EMBEDDED("shaders/shadow/shadow.frag", TEXT) const char g_shader_source_shadow_frag[];
